...
def _():
    ...
    scrubber_base_dir = Path("output/full/no-combine-missing")
...
@app.cell
def _(fpath_dashboard_output, fpath_missing_days, fpath_missing_repoints):
    ...
    return dashboard_df, missing_days_df, missing_repoints_df
